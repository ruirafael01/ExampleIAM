...
function Login() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('https://visma-economic.com:7032/api/authenticate', {
                email,
                password,
                returnUrl
            }, {
    ...
    const loginWithGoogle = async () => {
        try {
            ...
            const response = await fetch(
                `https://visma-economic.com:7032/api/authenticate/ExternalLogin?returnUrl=${returnUrl}&provider=Google`
            );
    ...
    return (
        <div>
            <div className="sc-visma-supergraphic">
